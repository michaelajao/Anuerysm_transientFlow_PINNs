...
# Existing functions: load_data_with_metadata, clean_and_convert
...
def process_all_datasets(file_paths, processed_dir="../../data/processed"):
    ...
    for name, path in file_paths.items():
        ...
        try:
            ...
            if phase == 'systolic':
                # Total systolic duration across all cycles
                total_phase_duration = systolic_duration * num_cycles  # 0.872 s
                # Generate time values evenly distributed over systolic phases
                t_values = np.linspace(0, total_phase_duration, num_samples, endpoint=False)
                # Map t_values to actual simulation times across cycles
                time_values = []
                cycle_index = 0
                for t in t_values:
                    while t >= (cycle_index + 1) * systolic_duration:
                        cycle_index += 1
                ...
                # Total diastolic duration across all cycles
                total_phase_duration = diastolic_duration * num_cycles  # 1.128 s
                # Generate time values evenly distributed over diastolic phases
                t_values = np.linspace(0, total_phase_duration, num_samples, endpoint=False)
                # Map t_values to actual simulation times across cycles
                time_values = []
                cycle_index = 0
                for t in t_values:
                    while t >= (cycle_index + 1) * diastolic_duration:
                        cycle_index += 1
            ...
            # Add patient-specific data (as in your original code)
            patient_data = {
...
def main():
    ...
    file_paths = {
        "0021_diastolic_aneurysm": "../../data/WSS_data/0021 Diastolic aneurysm.csv",
        "0021_systolic_aneurysm": "../../data/WSS_data/0021 Systolic aneurysm.csv",
        "0021_diastolic_global": "../../data/WSS_data/0021 Diastolic global.csv",
        "0021_systolic_global": "../../data/WSS_data/0021 systolic global.csv",
        "0022_systolic_aneurysm": "../../data/WSS_data/0022 systolic aneurysm.csv",
        "0022_diastolic_aneurysm": "../../data/WSS_data/0022 diastolic aneurysm.csv",
        "0022_systolic_global": "../../data/WSS_data/0022 systolic global.csv",
        "0022_diastolic_global": "../../data/WSS_data/0022 diastolic global.csv",
        "0023_diastolic_global": "../../data/WSS_data/0023 diastolic global.csv",
        "0023_systolic_aneurysm": "../../data/WSS_data/0023 systolic aneurysm.csv",
        "0023_diastolic_aneurysm": "../../data/WSS_data/0023 diastolic aneurysm.csv",
        "0023_systolic_global": "../../data/WSS_data/systolic global 0023.csv",
        "0024_systolic": "../../data/WSS_data/0024 systolic.csv",
        "0024_diastolic": "../../data/WSS_data/0024 diastolic.csv",
        "0025_diastolic_aneurysm": "../../data/WSS_data/0025 diastolic aneurysm.csv",
        "0025_diastolic_global": "../../data/WSS_data/0025 diastolic global.csv",
        "0025_systolic_aneurysm": "../../data/WSS_data/0025 systolic aneurysm.csv",
        "0025_systolic_global": "../../data/WSS_data/0025 systolic global.csv",
        "0142_systolic": "../../data/WSS_data/0142 systolic.csv",
        "0142_diastolic": "../../data/WSS_data/0142 diastolic.csv",
        # Add any additional datasets here
    }

    # Process all datasets
    processed_data = process_all_datasets(file_paths)
    ...
    for name in file_paths.keys():
        if name in processed_data:
            ...
            print(f"\n{name} was not processed due to previous errors.")
